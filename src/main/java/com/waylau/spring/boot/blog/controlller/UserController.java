...
import com.waylau.spring.boot.blog.utils.ConstraintViolationExceptionHandler;
...
public class UserController {
    ...
    public ModelAndView list(@RequestParam(value="async",required=false) boolean async,
        ...
        return new ModelAndView(async==true?"users/list :: "
        		+ "#mainContainerRepleace":"users/list", "userModel", model);
    }
